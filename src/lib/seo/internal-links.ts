...
export const PRODUCT_INTERNAL_LINKS: Record<string, ProductInternalLinks> = {
  "mea-triazine-78-h2s-scavenger": {
    ...
    relatedPages: [
      ...
      // ── Triazine application/scenario cluster (hub→spoke from the flagship
      //    product so every topic page has an authoritative inbound link) ──
      { href: "/sagd-h2s-scavenger", label: "SAGD H2S Scavenging", context: "Heavy-oil/oil-sands H2S control at elevated temperature" },
      { href: "/lpg-h2s-scavenger", label: "LPG H2S Scavenging", context: "H2S removal from LPG and NGL streams" },
      { href: "/storage-tank-h2s-scavenger", label: "Storage Tank H2S Scavenging", context: "Headspace and vapor-phase H2S control in tanks" },
      { href: "/marine-bunker-fuel-h2s-scavenger", label: "Marine Bunker Fuel H2S Scavenging", context: "H2S suppression in bunker/residual fuels" },
      ...
      { href: "/tank-truck-railcar-h2s-transport", label: "Tank Truck & Railcar H2S Transport", context: "Safe H2S levels for road/rail transport" },
      { href: "/triazine-corrosion-inhibitor-compatibility", label: "Triazine & Corrosion-Inhibitor Compatibility", context: "Co-dosing triazine with corrosion inhibitors" },
  ...
  "mma-triazine-40": {
    ...
    relatedPages: [
      ...
      { href: "/custom-triazine-blends-formulations", label: "Custom Triazine Blends", context: "Winterized / oil-soluble tailored formulations" },
      { href: "/how-h2s-scavengers-work", label: "How H2S Scavengers Work", context: "Technical guide to H2S scavenging chemistry" },
      // ── MMA Triazine 40% topic cluster (hub→spoke: de-orphans these landing
      //    pages by giving each an inbound link from the authoritative product) ──
      { href: "/how-mma-triazine-works-h2s-scavenging", label: "How MMA Triazine Works", context: "BTX-free MMA triazine H2S scavenging mechanism" },
      { href: "/why-choose-mma-triazine-40-h2s-scavenger", label: "Why Choose MMA Triazine 40%", context: "Advantages of BTX-free MMA triazine" },
      { href: "/buy-mma-triazine-40-h2s-scavenger", label: "Buy MMA Triazine 40%", context: "Purchasing, MOQ and quote request" },
      { href: "/mma-triazine-40-applications-industries", label: "MMA Triazine 40% Applications", context: "Industries and use cases for MMA triazine" },
      { href: "/mma-triazine-40-natural-gas-sweetening", label: "MMA Triazine for Natural Gas Sweetening", context: "Sour gas H2S removal with MMA triazine" },
      { href: "/mma-triazine-40-biogas-h2s-removal", label: "MMA Triazine for Biogas H2S Removal", context: "Biogas desulfurization with MMA triazine" },
      { href: "/mma-triazine-40-crude-oil-stabilisation", label: "MMA Triazine for Crude Oil Stabilisation", context: "H2S control in crude oil handling" },
      { href: "/mma-triazine-40-dosage-injection-rate-guide", label: "MMA Triazine Dosage & Injection Rate", context: "Dosing and injection-rate guidance" },
      { href: "/mma-triazine-40-cas-108-74-7-properties", label: "MMA Triazine Properties (CAS 108-74-7)", context: "Chemical identity and properties" },
      { href: "/mma-triazine-40-specifications-coa-datasheet", label: "MMA Triazine Specifications & COA", context: "Spec table, COA and datasheet" },
      { href: "/mma-triazine-40-safety-handling-storage", label: "MMA Triazine Safety & Handling", context: "Safe handling and storage guidance" },
      { href: "/mma-triazine-40-synonyms-trade-names", label: "MMA Triazine Synonyms & Trade Names", context: "Alternative names and identifiers" },
      { href: "/mma-triazine-40-price-supplier-india", label: "MMA Triazine Price & Supplier India", context: "Bulk price and factory-direct supply" },
      { href: "/mma-triazine-40-bulk-order-packaging-moq", label: "MMA Triazine Bulk Order & Packaging", context: "Packaging formats and MOQ" },
      { href: "/mma-triazine-40-export-supply-countries", label: "MMA Triazine Export Markets", context: "Export supply and destination countries" },
      { href: "/compare", label: "Product Comparisons", context: "Compare H2S scavenger products side by side" },
      ...DEFAULT_LINKS,
    ],
    industryPages: [
  ...
  "bit-20-benzisothiazolinone": {
    relatedProducts: [
      { href: "/product/bronopol", label: "Bronopol", context: "Fast-acting nitro-bromo preservative, often paired with BIT" },
      { href: "/product/sodium-dimethyldithiocarbamate", label: "Sodium Dimethyldithiocarbamate", context: "Biocide and heavy-metal precipitant for water treatment" },
    ],
    relatedPages: [
      { href: "/resources/bit-20-dosage-guide", label: "BIT 20% Dosage Guide", context: "Recommended use levels and preservative efficacy testing" },
      { href: "/resources/bit-20-price-supplier-india", label: "BIT 20% Price & Supplier Guide", context: "Pricing factors, MOQ, and evaluating a reliable supplier" },
      { href: "/resources/bit-20-vs-mit-cmit-preservatives", label: "BIT 20% vs MIT/CMIT Preservatives", context: "Compare isothiazolinone preservatives and when to combine them" },
      { href: "/resources/bit-20-safety-handling-storage", label: "BIT 20% Safety, Handling & Storage", context: "GHS hazards, PPE, storage conditions, and spill response" },
      { href: "/resources/benzisothiazolinone-uses-paints-coatings", label: "Benzisothiazolinone Uses in Paints & Coatings", context: "In-can preservation for emulsion and industrial coatings" },
      { href: "/resources/bit-20-for-adhesives-inks", label: "BIT 20% for Adhesives & Inks", context: "Preservation for PVA, acrylic adhesives and aqueous inks" },
      { href: "/resources/bit-20-for-metalworking-fluids", label: "BIT 20% for Metalworking Fluids", context: "Dosage and compatibility in cutting oil concentrates" },
      { href: "/resources/benzisothiazolinone-vs-bronopol-formaldehyde-biocides", label: "BIT vs Bronopol & Formaldehyde Biocides", context: "Comparing biocide classes and formaldehyde-free positioning" },
      { href: "/resources/bit-20-cosmetic-personal-care-preservative", label: "BIT 20% as a Cosmetic Preservative", context: "Regulatory limits and personal care application guidance" },
      { href: "/resources/bit-20-detergent-household-cleaning-preservative", label: "BIT 20% for Detergents & Household Cleaning", context: "Preservation for liquid detergents and cleaning products" },
      { href: "/resources/preventol-nipacide-mergal-bit-20-alternative-india", label: "Preventol / Nipacide / Mergal BIT 20 Alternative", context: "Brand equivalence and supplier qualification guidance" },
      { href: "/resources/benzisothiazolinone-cas-2634-33-5-technical-data", label: "Benzisothiazolinone Technical Data (CAS 2634-33-5)", context: "Complete chemical identity and physical property reference" },
      { href: "/resources/bit-20-leather-textile-processing", label: "BIT 20% for Leather & Textile Processing", context: "Tanning liquor and textile spin-finish preservation" },
      { href: "/resources/bit-20-construction-chemicals-wood-preservation", label: "BIT 20% for Construction Chemicals & Wood Preservation", context: "Grouts, admixtures, wood preservatives, and drilling fluids" },
      { href: "/resources/benzisothiazolinone-allergy-toxicity-environmental-impact", label: "Benzisothiazolinone Allergy, Toxicity & Environmental Impact", context: "Sensitisation data, aquatic toxicity, and regulatory status" },
      ...DEFAULT_LINKS,
    ],
    industryPages: [
      INDUSTRY_LINKS.personalCare[0],
      INDUSTRY_LINKS.waterTreatment[0],
      INDUSTRY_LINKS.metalworking[0],
    ],
  },
  "bronopol": {
    relatedProducts: [
      { href: "/product/bit-20-benzisothiazolinone", label: "BIT 20% (Benzisothiazolinone)", context: "Broader-spectrum isothiazolinone preservative, often paired with Bronopol" },
      { href: "/product/sodium-dimethyldithiocarbamate", label: "Sodium Dimethyldithiocarbamate", context: "Biocide and heavy-metal precipitant for water treatment" },
    ],
    relatedPages: [
      { href: "/resources/bronopol-dosage-guide", label: "Bronopol Dosage Guide", context: "Recommended use levels and preservative efficacy testing" },
      { href: "/resources/bronopol-price-supplier-india", label: "Bronopol Price & Supplier Guide", context: "Pricing factors, MOQ, and evaluating a reliable supplier" },
      { href: "/resources/bronopol-vs-bit-benzisothiazolinone", label: "Bronopol vs BIT (Benzisothiazolinone)", context: "Compare the two preservatives and when to combine them" },
      { href: "/resources/bronopol-safety-handling-storage", label: "Bronopol Safety, Handling & Storage", context: "GHS hazards, PPE, storage conditions, and spill response" },
      { href: "/resources/bronopol-uses-cosmetics-personal-care", label: "Bronopol Uses in Cosmetics & Personal Care", context: "Shampoos, lotions, and personal care regulatory limits" },
      { href: "/resources/bronopol-nitrosamine-formation-risk", label: "Bronopol Nitrosamine Formation Risk", context: "Mechanism, secondary amine incompatibility, and mitigation" },
      { href: "/resources/bronopol-for-water-treatment-cooling-towers", label: "Bronopol for Water Treatment & Cooling Towers", context: "Cooling water and air washer system preservation" },
      { href: "/resources/bronopol-for-metalworking-fluids-cutting-oils", label: "Bronopol for Metalworking Fluids & Cutting Oils", context: "Dosage and compatibility in cutting oil concentrates" },
      { href: "/resources/bronopol-vs-formaldehyde-donors", label: "Bronopol vs Formaldehyde Donors", context: "Mechanism comparison and regulatory positioning" },
      { href: "/resources/bronopol-for-paper-mill-pulp-processing", label: "Bronopol for Paper Mill & Pulp Processing", context: "Slime control applications in paper manufacturing" },
      { href: "/resources/bronopol-for-oilfield-drilling-fluids", label: "Bronopol for Oilfield Drilling Fluids", context: "SRB control in drilling and production systems" },
      { href: "/resources/onyxide-500-lexgard-myacide-bronopol-alternative-india", label: "Onyxide 500 / Lexgard / Myacide Bronopol Alternative", context: "Brand equivalence and supplier qualification guidance" },
      { href: "/resources/bronopol-cas-52-51-7-technical-data", label: "Bronopol Technical Data (CAS 52-51-7)", context: "Complete chemical identity and physical property reference" },
      { href: "/resources/bronopol-mechanism-of-action-pseudomonas", label: "Bronopol Mechanism of Action & Pseudomonas Control", context: "Antimicrobial mechanism deep-dive" },
      { href: "/resources/bronopol-pharmacopoeia-grades-ip-bp-ph-eur", label: "Bronopol Pharmacopoeia Grades (IP/BP/Ph.Eur.)", context: "Grade differences and pharmaceutical use" },
      { href: "/resources/bronopol-stability-ph-temperature", label: "Bronopol Stability: pH & Temperature", context: "Decomposition chemistry and stabilisation methods" },
      { href: "/resources/bronopol-allergy-toxicity-environmental-impact", label: "Bronopol Allergy, Toxicity & Environmental Impact", context: "Dermatitis, aquatic toxicity, and regulatory status" },
      { href: "/resources/bronopol-for-household-cleaning-products", label: "Bronopol for Household Cleaning Products", context: "Detergents and household cleaner preservation" },
      { href: "/resources/bronopol-compatibility-surfactants-formulation", label: "Bronopol Compatibility with Surfactants", context: "Formulation compatibility guide" },
      { href: "/resources/bronopol-vs-parabens-preservative-comparison", label: "Bronopol vs Parabens Preservative Comparison", context: "Comparing Bronopol with paraben-based preservatives" },
      ...DEFAULT_LINKS,
    ],
    industryPages: [
      INDUSTRY_LINKS.personalCare[0],
