...
const RAW_COUNTRY_PAGES_DATA: Record<string, CountryPageData> = {
  ...
  brazil: {
    ...
    intro:
      "Vasudev Chemo Pharma ships MEA Triazine 78% to Brazil via Santos Port and Paranagu\u00E1 with transit times of 20\u201325 days from India. Each shipment includes a Certificate of Analysis in Portuguese and English, a GHS-compliant SDS meeting ABNT-NBR standards, and documentation formatted for Receita Federal customs clearance. Our MEA Triazine 78% can be supplied to align with the concentration and identity referenced in Petrobras specification ET-3010.00-1260-010-PNG-027 — confirm current specification requirements with our technical team.",
    logistics: {
