...
export const EDDM_SYNONYMS: ProductSynonyms = {
  intro:
    "EDDM (Ethylenedioxydimethanol) is known by several chemical names, IUPAC variants, trade names, and application-based names worldwide. Vasudev Chemo Pharma's EDDM is the same compound regardless of which name your specification, MSDS, or purchase order uses:",
  groups: [
    {
      heading: "IUPAC and Chemical Names",
      items: [
        ...
        "Dimethylol glycol",
        "2,5-Dioxa-hexane-1,6-diol",
        "[2-(hydroxymethoxy)ethoxy]methanol",
      ],
    },
    {
      heading: "Trade Names and Branded Products",
      items: [
        "Preventol® EDDM (Lanxess)",
        "Preventol® D 9 (Lanxess)",
        "Vinkocide® 825 (Vink Chemicals)",
        "Vinkocide® CMIF (Vink Chemicals)",
        "GROTAN TK5",
        "Nipacide FC",
        "Dascocide 9",
        "Bodoxin AH",
    ...
    },
    {
      ...
      items: [
        ...
        "INCI Name: DIMETHYLOL GLYCOL",
        "HS Code 2909 49 9000",
      ],
    },
    {
      heading: "Application-Based Names",
      items: [
        ...
        "Slow-Release Formaldehyde Donor Biocide",
        "In-Can Preservative",
        "Metalworking Fluid Biocide",
        "Oilfield Desulfurizer",
        "Non-Corrosive H2S Scavenger",
        "Gas Phase Sterilization Agent",
        "Non-Triazine Desulfurizer",
        "Controlled-Release Bactericide",
        "Water Treatment Biocide EDDM",
      ],
    },
  ],
  casNote: "CAS Number: 3586-55-8 | EINECS: 222-720-6 | Molecular Formula: C₄H₁₀O₄ | MW: 122.12 g/mol",
  closingText:
    "Contact us if your specification lists any of these names — we will confirm whether our EDDM product matches your requirement. Vasudev Chemo Pharma is a direct replacement supplier for Preventol® EDDM, Vinkocide® 825, Nipacide FC, and all equivalent formulations.",
};
