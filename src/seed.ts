...
type SeedProduct = {
  ...
  /** Optional override. Defaults to ["ISO 9001:2015"] in the seed loop. */
...
const productSpecificFaqs: Record<string, { question: string; answer: string }[]> = {
  ...
  "benzalkonium-chloride-50": [
    ...
    },
    {
      ...
      answer:
        "BKC 50% and BKC 80% are the same active substance (ADBAC, CAS 8001-54-5) at different concentrations in water. BKC 50% is the ready-to-formulate global standard — easier to pump at room temperature, lower viscosity, and the most common reference grade in disinfectant formulation manuals. BKC 80% is the concentrated export-economical grade preferred by sanitiser blenders who dilute on-site to 50%, 25%, or 10% — it ships less water per kilogram of active and reduces freight cost, but is more viscous and may gel below 15°C, so warm storage is recommended.",
    },
    {
      question: "Is Benzalkonium Chloride effective against viruses including coronaviruses?",
      answer:
        "Yes. BKC is a proven virucide against enveloped viruses including coronaviruses (SARS-CoV-2, MERS-CoV), influenza, herpes, and HIV when used at the manufacturer's recommended in-use concentration (typically 0.05% – 0.4% active matter) with adequate contact time (usually 1 – 10 minutes depending on the test organism). Efficacy against non-enveloped viruses (e.g. norovirus, poliovirus) is limited and BKC is generally not the first-choice disinfectant for those pathogens. Always validate efficacy against the specific organisms and surfaces in your application.",
    },
    {
      question: "What is the recommended in-use concentration of BKC 50% for surface disinfection?",
      answer:
        "Typical in-use concentrations of BKC 50% for surface disinfection are 0.1% – 0.4% (1,000 – 4,000 ppm active quat). For routine hard-surface sanitation, dilute 1 part BKC 50% in 125 – 500 parts water (yielding 0.1% – 0.4% active). For food-contact surfaces, follow local regulations (e.g. US FDA 21 CFR 178.1010 limits no-rinse food-contact use to 200 ppm active quat). For agricultural and veterinary disinfection, follow the product label and local biocidal regulations. Always validate efficacy against the target organisms for your specific application.",
    },
    {
      question: "What grades and certifications does Vasudev Chemo Pharma offer for BKC 50%?",
      answer:
        "Vasudev Chemo Pharma supplies BKC 50% in three grades: Industrial / Technical Grade for general industrial use, Cosmetic Grade (CTFA-compliant) for personal-care preservation, and Disinfectant Grade suitable for EPA-registered formulators. Our manufacturing facility in Gujarat, India is ISO 9001:2015, GMP, and Halal certified. Every shipment includes a batch-specific Certificate of Analysis (COA), Safety Data Sheet (SDS), Technical Data Sheet (TDS), and Halal/GMP certificates on request, along with full export documentation for global shipments.",
    },
    {
      question: "Is BKC compatible with anionic surfactants in formulations?",
      answer:
        "No — BKC is a cationic surfactant and is generally incompatible with anionic surfactants such as LABSA, SLES, SLS, or anionic hydrotropes (SCS, SXS). Mixing the two leads to ion-pair complexation, precipitation, and complete loss of biocidal activity. BKC is fully compatible with nonionic surfactants (alcohol ethoxylates, APGs), amphoteric surfactants (cocamidopropyl betaine), and other cationic systems. Always pre-test formulations to confirm compatibility, clarity, and biocidal performance before scale-up.",
    },
    {
      question: "Is BKC 50% from Vasudev Chemo Pharma exported globally?",
      answer:
        "Yes. We export BKC 50% (HS code 29239000) worldwide from our Gujarat facility to disinfectant manufacturers, sanitiser blenders, cosmetic preservation houses, water-treatment chemical companies, agricultural disinfectant brands, and pharmaceutical preservative formulators across the USA, EU, UAE, Saudi Arabia, Brazil, Vietnam, Russia, Egypt, and over 30 other countries. Shipments are supported with FOB / CIF / CFR Incoterms from Kandla, Mundra, and Hazira ports, with full export documentation including Halal and GMP certificates where required.",
    },
    {
      question: "What safety precautions are required when handling BKC 50%?",
      answer:
        "BKC 50% is classified as Corrosive (GHS05), Irritant (GHS07), and Environmentally Hazardous (GHS09), with hazard statements H302 (harmful if swallowed), H314 (causes severe skin burns and eye damage), H318 (causes serious eye damage), and H400/H410 (very toxic to aquatic life). Handling requires chemical-resistant gloves (nitrile or neoprene), splash-proof safety goggles, face shield, and protective clothing. Provide local exhaust ventilation. Do not discharge BKC waste into waterways, drains, or septic systems — neutralise with anionic surfactants and dispose via licensed hazardous-waste contractors. The full SDS is supplied with every shipment.",
    },
  ],
  "benzalkonium-chloride-80": [
    {
      ...
      answer:
        "BKC 80% is a high-active 80% aqueous solution of Alkyl Dimethyl Benzyl Ammonium Chloride (ADBAC, CAS 8001-54-5) — the export-economical grade preferred by global disinfectant brands, sanitiser blenders, cosmetic preservation houses, and water-treatment chemical companies who dilute on-site to 50%, 25%, 10%, or final-use concentrations. End-use applications include hospital and clinical surface disinfection, food and beverage CIP/COP sanitation, swimming-pool algicides, cosmetic and pharmaceutical preservation, cooling-tower and HVAC biocide, agricultural disinfection, wood preservation, and phase-transfer catalysis.",
    },
    {
      question: "Why choose BKC 80% over BKC 50%?",
      answer:
        "BKC 80% delivers 60% more active matter per kilogram of shipped product than BKC 50%, which significantly reduces freight cost per kilogram of quat — particularly meaningful for ocean exports to Latin America, Africa, and the Middle East. It also requires less storage volume on-site. Trade-offs: BKC 80% is more viscous, may gel below 15°C (warm-room storage recommended), and requires gentle warming or vigorous mixing to dilute into water. Buyers who plan to dilute on-site or who pay high freight per kg should prefer BKC 80%; buyers who use the product as-is for direct formulation should prefer BKC 50%.",
    },
    {
      question: "How do I dilute BKC 80% to make BKC 50% or final-use concentration?",
      answer:
        "To make BKC 50% from BKC 80%, blend 62.5 kg of BKC 80% with 37.5 kg of demineralised water (mass ratio) — yielding 100 kg of BKC 50%. For final-use disinfectant concentrations of 0.1% – 0.4% active, dilute 1.25 – 5.0 g of BKC 80% per litre of water (1 part BKC 80% in 200 – 800 parts water). Always add BKC concentrate to water (not water to concentrate), use demineralised or low-hardness water to avoid Ca/Mg precipitation, and gently warm BKC 80% to 25 – 30°C if it has gelled. Validate final active content by titration before use.",
    },
    {
      question: "What is the storage requirement for BKC 80% to prevent gelation?",
      answer:
        "BKC 80% should be stored between 15°C and 40°C in sealed HDPE drums, away from direct sunlight. Below 15°C, BKC 80% becomes viscous and can form a soft gel that takes time to redissolve. If gelation occurs, gently warm the drum to 25 – 30°C for 24 – 48 hours and roll/agitate to homogenise — the product fully recovers without loss of activity. For winter storage in cold climates, insulated warehousing or heated bulk-tank storage is recommended. Shelf life is 24 months in original sealed packaging.",
    },
    {
      question: "Is BKC 80% from Vasudev Chemo Pharma equivalent to Lonza Bardac® or Stepan BTC®?",
      answer:
        "Yes. Vasudev Chemo Pharma's BKC 80% is functionally equivalent to Lonza Bardac® 2280, Stepan BTC® 8358, Nouryon Maquat® 4480E, and Pilot Lonzabac® 80% — all of which are 80% ADBAC concentrates with C₁₂–C₁₆ alkyl distribution. Our typical alkyl ratio (C₁₂ 40–50% / C₁₄ 30–40% / C₁₆ 10–20%) matches the global formulation reference standard used by EPA-registered disinfectant formulators. Customers cross-qualifying our product report drop-in replacement performance in surface disinfection, water-treatment, and preservative applications. We provide spec-comparison documents and trial samples on request.",
    },
    {
      question: "What grades and certifications does Vasudev Chemo Pharma offer for BKC 80%?",
      answer:
        "BKC 80% is supplied in Industrial / Technical Grade, Cosmetic Grade (CTFA-compliant), and Disinfectant Grade suitable for EPA-registered formulators. Our facility is ISO 9001:2015, GMP, and Halal certified, with shipment documentation including COA, SDS, TDS, Halal certificate, GMP certificate, and full export paperwork. We supply USA, EU, UAE, Saudi Arabia, Brazil, Vietnam, Russia, and Egypt — among other markets — with FOB / CIF / CFR Incoterms from Kandla, Mundra, and Hazira ports.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "BKC 80% is classified as Corrosive (GHS05), Irritant (GHS07), and Environmentally Hazardous (GHS09), with hazard statements H302 (harmful if swallowed), H314 (causes severe skin burns and eye damage), H318 (causes serious eye damage), and H400/H410 (very toxic to aquatic life). The 80% concentration is more aggressive than the 50% grade — splashes can cause severe chemical burns within seconds. Handling requires chemical-resistant gloves (neoprene preferred), splash-proof goggles, face shield, apron, and access to an emergency eyewash and safety shower. Provide local exhaust ventilation. Never discharge BKC waste into waterways or drains. Full SDS is supplied with every shipment.",
    },
  ],
};
...
const seedProducts: SeedProduct[] = [
  ...
  // ─── Benzalkonium Chloride (BKC) — Cationic Surfactant / Quat Biocide ───
  {
    ...
    description:
      "Benzalkonium Chloride 50% (BKC 50%) is a high-purity, ready-to-use 50% aqueous solution of Alkyl Dimethyl Benzyl Ammonium Chloride (ADBAC) — a broad-spectrum cationic surfactant and quaternary ammonium biocide. Effective against gram-positive and gram-negative bacteria, fungi, yeast, algae, and enveloped viruses. The 50% liquid grade is the global formulation standard for hospital surface disinfectants, food and beverage CIP/COP sanitation, swimming-pool algicides, cosmetic and pharmaceutical preservation, industrial cooling-tower and HVAC water treatment, agricultural and veterinary disinfection, wood preservation, and as a phase-transfer catalyst in fine-chemical synthesis. Manufactured by Vasudev Chemo Pharma at our ISO 9001:2015, GMP, and Halal-certified facility in Gujarat, India, with controlled C₁₂–C₁₆ alkyl distribution and full COA, SDS, TDS, Halal, and GMP documentation. Available in Industrial / Technical, Cosmetic (CTFA), and Disinfectant grades for EPA-registered formulators.",
    appearance: "Clear to slightly viscous pale yellow liquid",
    molecularWeight: "354.0 g/mol (avg, mixed alkyl C₁₂–C₁₆)",
    hsCode: "29239000",
    originCountry: "India",
    priceUnit: "/MT",
    unitOfMeasure: "MT",
    ...
    applications: [
      ...
      "Food & beverage industry CIP / COP sanitation (dairy, brewery, soft drinks)",
      ...
      "Agricultural disinfection (poultry, dairy, hatcheries, greenhouses, foot baths)",
      ...
      "Phase-transfer catalyst in fine-chemical and pharmaceutical synthesis",
  ...
  },
  {
    ...
    subcategory: "Quaternary Ammonium Compounds (Quats)",
    description:
      "Benzalkonium Chloride 80% (BKC 80%) is a high-active, concentrated 80% aqueous solution of Alkyl Dimethyl Benzyl Ammonium Chloride (ADBAC) — the export-economical grade preferred by global disinfectant brands, sanitiser blenders, cosmetic preservation houses, and water-treatment chemical companies who dilute on-site to 50%, 25%, 10%, or final-use concentrations. Effective against gram-positive and gram-negative bacteria, fungi, yeast, algae, and enveloped viruses. Used in hospital surface disinfectants, food and beverage CIP/COP, swimming-pool algicides, cosmetic and pharmaceutical preservation, cooling-tower and HVAC biocide, agricultural and veterinary disinfection, wood preservation, and as a phase-transfer catalyst. Manufactured by Vasudev Chemo Pharma at our ISO 9001:2015, GMP, and Halal-certified facility in Gujarat, India. Equivalent to Lonza Bardac® 2280, Stepan BTC® 8358, Nouryon Maquat® 4480E, and Pilot Lonzabac® 80% reference grades. Supplied with full COA, SDS, TDS, Halal, GMP, and export documentation in Industrial / Technical, Cosmetic (CTFA), and Disinfectant grades.",
    appearance: "Clear to pale yellow viscous liquid (gel-like at low temperatures)",
    molecularWeight: "354.0 g/mol (avg, mixed alkyl C₁₂–C₁₆)",
    hsCode: "29239000",
    originCountry: "India",
    priceUnit: "/MT",
    ...
    specs: [
      ...
      { key: "Solubility in Water", value: "Fully miscible (gentle warming may be required)" },
    ...
    applications: [
      ...
      "Hospital, clinical, and pharmaceutical surface disinfection (after dilution)",
  ...
  for (const product of seedProducts) {
    await payload.create({
      ...
      data: {
        ...
        certifications: product.certifications ?? ["ISO 9001:2015"],
        currency: "USD",
        price: 0,
